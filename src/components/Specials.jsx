...
const Specials = () => {
  return (
    <div className="menu">
        ...
        <div className="cards">
            <div className="card">
                <img className="menu-img" src={"/greek-salad.png"} alt="greek salad"/>
            ...
            <div className="card">
                <img className="menu-img" src={"/bruschetta.jpeg"} alt="bruchetta"/>
                <div className="name-price">
            ...
            <div className="card">
                <img className="menu-img" src={"/lemon.jpg"} alt="lemon-dessert"/>
                <div className="name-price">
